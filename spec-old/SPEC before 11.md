...
- The five `needs-front-door` and `needs-register` rows stay unmeasurable for every
...
```
Σ vendor blocked value across a page's visible vendors  =  worklist shown value
Σ plant blocked value across an entity's plants          =  worklist shown value
Σ cost centre committed spend                            =  PO stage in-flight value
Σ customer exposure                                      ≥  AR over 90 days
```

For JGL that is ₹12.77 cr, ₹12.77 cr, ₹58.4 cr and ≥ ₹12.4 cr respectively.
