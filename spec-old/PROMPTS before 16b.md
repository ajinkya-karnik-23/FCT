...
```
Read SPEC.md §6 (Request interface), §7.29, §7.26 and §7.7.
...
```
Read SPEC.md §7.5, §7.30 and §7.29.
...
11. Per SPEC.md §8.6.1, confirm every derived KPI exposes its definition on hover or
...
one line that beat is making.
  ...
  3  Ask the Control Tower: "why is this entity capped?" The highlight answer, with
     drillable citations.
  4  JGL entity health. Financial consequence strip: ₹18.6 cr blocked → ₹6.4 cr will
     not accrue in 3 days unless goods receipts are posted.
  5  Drill the accrual figure. Blocked worklist filtered to goods receipt: 12 of 327
     shown, ₹12.77 cr of ₹18.6 cr, oldest 52 days, 4 of 38 resolvable.
