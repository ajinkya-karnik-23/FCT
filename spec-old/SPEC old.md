...
JRP carries one active veto: `unauthorised vendor bank change, unresolved`,
cap 55. All other entities have no active veto.
...
- **Read the existing tokens from the codebase and reuse them.** Do not introduce
  new colours, fonts, radii or spacing values.
