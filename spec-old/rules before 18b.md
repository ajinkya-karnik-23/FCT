...
**One thing this does not strip.** A number cannot describe itself, so labelling what a
figure *means* stays: "Open work in progress" on the stage cards, "12 of 327 shown", the
