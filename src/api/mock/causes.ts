...
export const causes: CauseNode[] = [
  {
    ...
    key: 'missing-gr',
    name: 'Missing GR',
    originatingFunction: 'Plant & warehouse',
    sharePct: 34,
    valueAtRisk: 6.4,
    avgDelayDays: 8.4,
    recurrence: 5,
  ...
  },
  {
    ...
    originatingFunction: 'Procurement',
    sharePct: 22,
    valueAtRisk: 4.1,
    avgDelayDays: 6.1,
    recurrence: 3,
  ...
  },
  {
    ...
    originatingFunction: 'Business approvers',
    sharePct: 18,
    valueAtRisk: 3.3,
    avgDelayDays: 5.2,
    recurrence: 2,
  ...
  },
  {
    ...
    key: 'vendor-master',
    name: 'Vendor master',
    originatingFunction: 'Master data',
    sharePct: 11,
    valueAtRisk: 2.0,
    avgDelayDays: 9.7,
    recurrence: 4,
  ...
  // spec/08 Part C — O2C taxonomy. `plants` carries customer segments, `vendors` cause drivers.
  {
    ...
    originatingFunction: 'Commercial',
    sharePct: 31,
    valueAtRisk: 5.4,
    avgDelayDays: 11.2,
    recurrence: 6,
